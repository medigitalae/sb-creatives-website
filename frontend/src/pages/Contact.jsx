            ...
            <div className="lg:col-span-5">
              ...
              <FadeUp delay={0.3}>
                ...
                <div className="mt-12 space-y-6">
                  ...
                  <a href="https://wa.me/918943783080" target="_blank" rel="noreferrer" className="group flex items-start gap-4">
                    <span className="mt-1 inline-flex h-11 w-11 items-center justify-center rounded-full bg-seafoam/60 text-ocean shrink-0">
                    ...
                    <span>
                      <span className="block text-xs uppercase tracking-widest text-graphite">WhatsApp</span>
                      <span className="block font-heading font-semibold text-charcoal text-lg group-hover:text-cadet transition-colors duration-300">+91 89437 83080</span>
                    </span>
                  </a>
